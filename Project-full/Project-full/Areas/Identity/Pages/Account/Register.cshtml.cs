...
namespace Project_full.Areas.Identity.Pages.Account
{
	public class RegisterModel : PageModel
	{
		...
		private readonly ILogger<Osoba> _logger;
		...
		public async Task<IActionResult> OnPostAsync(string returnUrl = null)
		{
			...
			if (ModelState.IsValid)
			{
				...
				var user = new Osoba
				{
					...
					TelefonniCislo = Input.TelefonniCislo,
					Bonus = 0 //,
					//UserId = user.Id //Osoba již dìdí z IndetityUser, není tøeba øešit Id
				}; 
